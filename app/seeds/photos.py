...
photo2 = Photo(user_id=2, title='McCaffrey and Deebo', description="Christian McCaffrey and Deebo Samuel gameplanning on the sideline.", url='https://www.nbcsports.com/sites/rsnunited/files/article/hero/deebo-samuel-christian-mccaffrey-49ers-GETTY.jpg')
...
photo9 = Photo(user_id=3, title='Homerun Kings', description='Aaron Judge or Barry Bonds?', url='https://www.nbcsports.com/sites/rsnunited/files/article/hero/aaron-judge-barry-bonds-getty.jpg')
...
photo13 = Photo(user_id=1, title='James with the Dunk', description="LeBron James' ability to drive to the basket and finish with a thunderous dunk down the lane is one of the most iconic moves in basketball, and has helped solidify James as one of the greatest players of all time.", url='https://rare-gallery.com/uploads/posts/1071503-sports-basketball-stadium-NBA-structure-LeBron-James-Slam-Dunk-player-football-player-sport-venue-basketball-player-team-sport-basketball-moves.png')
